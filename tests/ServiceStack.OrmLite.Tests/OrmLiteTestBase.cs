...
namespace ServiceStack.OrmLite.Tests
{
    public class Config
    {
        ...
        public static string SqlServerBuildDb = @"Server=(localdb)\MSSQLLocalDB;Database=test;Integrated Security=SSPI;MultipleActiveResultSets=True;";
        ...
        public static string PostgreSqlDb = "Server=localhost;Port=5432;User Id=postgres;Password=admin;Database=test;Pooling=true;MinPoolSize=0;MaxPoolSize=200";
